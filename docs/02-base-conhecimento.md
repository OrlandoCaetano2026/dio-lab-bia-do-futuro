...
Existem duas possibildades, inserção dos dados diretamente no pront (ctr + c , ctrl + v) ou imputar os arquivos via codigo, conforme exemplo abaixo:
...
Historico do Cliente:(historico_atendimento.csv)
...
[
  ...
  {
    "nome": "Fundo Imobiliário (FFI)",
    "categoria": "fundo",
    "risco": "medio",
    "rentabilidade": "10% e 15% ao ano",
    "aporte_minimo": 10.00,
...
- LCI/LCA (risco baixo)
- Fundo IMobiliário - FII (risco medio)
